    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String solution = request.getParameter("solution");
                    ...
                    UserReceiptDetail userReceiptDetail = new UserReceiptDetail(quantityInBill, quantityInShipping, receiptID, productID, receiptID, solution);
                    boolean checkCreate = dao.createReceiptDetail(userReceiptDetail);
                    if (checkCreate) {
                        url = SUCCESS;
                    }
